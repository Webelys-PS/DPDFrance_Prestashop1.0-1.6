...
function dpdfrance_relais_ajaxupdate(address, zipcode, city, action, cart_id)
{
        ...
        <td colspan="5" style="padding:0px;">
            ...
            {if $ssl == 0 || $ssl_everywhere == 1}
                ...
                <div id="dpdfrance_div_relais_srch_panel" style="display:none;">
                    ...
                    <button type="button" id="dpdfrance_search_submit" name="dpdfrance_search_submit" onclick="dpdfrance_relais_ajaxupdate($('#dpdfrance_search_address').val(), $('#dpdfrance_search_zipcode').val(), $('#dpdfrance_search_city').val(), 'search', cart_id);">{l s='Search' mod='dpdfrance'}</button>
                    <button type="button" id="dpdfrance_reset_submit" name="dpdfrance_reset_submit" onclick="dpdfrance_relais_ajaxupdate($('#dpdfrance_search_address').val(), $('#dpdfrance_search_zipcode').val(), $('#dpdfrance_search_city').val(), 'reset', cart_id);">{l s='Reset' mod='dpdfrance'}</button>
                </div>
            {/if}
        </td>
    </tr>
