...
<script type="text/javascript" src="{if $ssl}{$base_dir_ssl|escape:'javascript':'UTF-8'}{else}{$base_dir|escape:'javascript':'UTF-8'}{/if}modules/dpdfrance/views/js/front/dpdfrance.js"></script>
